...
if &t_Co > 255
  ...
  highlight SignColumn      ctermfg=244     ctermbg=235     cterm=bold
  highlight Conceal         ctermfg=251     ctermbg=none    cterm=bold
  highlight SpellBad        ctermfg=168     ctermbg=none    cterm=underline
  highlight SpellCap        ctermfg=80      ctermbg=none    cterm=underline
  highlight SpellRare       ctermfg=121     ctermbg=none    cterm=underline
  highlight SpellLocal      ctermfg=186     ctermbg=none    cterm=underline
  highlight Pmenu           ctermfg=251     ctermbg=234     cterm=bold
  highlight PmenuSel        ctermfg=0       ctermbg=111     cterm=bold
  ...
  highlight CursorColumn    ctermfg=none    ctermbg=236     cterm=bold
  highlight CursorLine      ctermfg=none    ctermbg=236     cterm=bold
  highlight ColorColumn     ctermfg=none    ctermbg=236     cterm=bold
